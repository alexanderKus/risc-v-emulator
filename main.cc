...
enum {
  ...
  FUNCT3_SBREAK     = 0b00000000000000000000000000000000,
  FUNCT3_SRDCYCLE   = 0b00000000000000000000000000000000,
  FUNCT3_SRDCYCLEH  = 0b00000000000000000000000000000000,
  FUNCT3_RDTIME     = 0b00000000000000000000000000000000,
  FUNCT3_RDTIMEH    = 0b00000000000000000000000000000000,
  FUNCT3_RDINSTRET  = 0b00000000000000000000000000000000,
  FUNCT3_RDINSTRETH = 0b00000000000000000000000000000000,
